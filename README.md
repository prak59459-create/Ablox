...
- [`docs/scripting.ja.md`](docs/scripting.ja.md) — `.absc` でゲームを作る（画面GUI、カメラ、キャラ、NPC、マップ編集、銃）
- [`docs/scripting.md`](docs/scripting.md) — AbloxScript (`.absc`): the language, the API, its limits, and why it is not Swift
